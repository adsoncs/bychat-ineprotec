...
import('./services/chatImportRunner.js')
  .then(m => m.startChatImportWorker())
  .catch(err => console.error('[chatImport] init falhou:', err?.message || err))
import('./services/profilePictureSync.js')
  ...
  import('./services/aiJourneyScheduler.js')
    .then(m => m.startAiJourneyScheduler())
    .catch(err => console.warn('[aiJourneyScheduler] init falhou:', err?.message || err))
