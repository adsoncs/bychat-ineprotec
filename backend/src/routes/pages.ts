...
const PAGE_TEMPLATES = [
  {
    ...
    description: 'Hero + benefícios + depoimentos + formulário. Ideal para campanhas de tráfego pago.',
    thumbnailUrl: null,
    category: 'Aquisição',
    sections: [
      { id: 't1', type: 'hero', visible: true, props: { headline: 'Transforme visitantes em clientes', subheadline: 'Descubra como nossa solução pode acelerar seu crescimento.', ctaText: 'Quero saber mais', ctaLink: '#form', badge: 'Gratuito', alignment: 'center' } },
      { id: 't2', type: 'features', visible: true, props: { heading: 'Como funciona', subheading: 'Simples, rápido e eficiente', items: [
      ...
      { id: 't3', type: 'testimonials', visible: true, props: { heading: 'O que dizem nossos clientes', items: [
      ...
      { id: 't4', type: 'form', visible: true, props: { heading: 'Solicite seu diagnóstico gratuito', subheading: 'Preencha e receba em instantes.', formId: null } },
      { id: 't5', type: 'footer', visible: true, props: { text: '' } },
    ],
    globalStyles: { primaryColor: '#1a73e8' },
  },
  {
    id: 'webinar',
    name: 'Inscrição Webinar',
    description: 'Página focada em inscrição para evento online com countdown e vídeo.',
    thumbnailUrl: null,
    category: 'Eventos',
    sections: [
      { id: 'w1', type: 'hero', visible: true, props: { headline: 'Webinar Exclusivo: [Tema]', subheadline: 'Dia XX/XX às XXh. Vagas limitadas.', ctaText: 'Garantir minha vaga', ctaLink: '#form', badge: 'AO VIVO', alignment: 'center' } },
      { id: 'w2', type: 'features', visible: true, props: { heading: 'O que você vai aprender', items: [
      ...
      { id: 'w3', type: 'video', visible: true, props: { heading: 'Assista ao trailer', url: '' } },
      { id: 'w4', type: 'form', visible: true, props: { heading: 'Inscreva-se agora', subheading: 'Vagas limitadas — garanta a sua!', formId: null } },
      { id: 'w5', type: 'footer', visible: true, props: { text: '' } },
    ],
    globalStyles: { primaryColor: '#7b1fa2' },
  },
  {
    id: 'product',
    name: 'Lançamento de Produto',
    description: 'Hero impactante + features + pricing + CTA. Para lançar serviços ou produtos.',
    thumbnailUrl: null,
    category: 'Vendas',
    sections: [
      { id: 'p1', type: 'hero', visible: true, props: { headline: 'Apresentamos [Produto]', subheadline: 'A solução definitiva para [problema].', ctaText: 'Ver planos', ctaLink: '#pricing', badge: 'NOVO', alignment: 'center' } },
      { id: 'p2', type: 'features', visible: true, props: { heading: 'Funcionalidades', items: [
      ...
      { id: 'p3', type: 'pricing', visible: true, props: { heading: 'Planos', subheading: 'Escolha o ideal para você', anchorId: 'pricing', items: [
      ...
      { id: 'p4', type: 'form', visible: true, props: { heading: 'Interessado?', subheading: 'Fale com nosso time.', formId: null } },
      { id: 'p5', type: 'footer', visible: true, props: { text: '' } },
    ],
    globalStyles: { primaryColor: '#0d47a1' },
  },
  {
    id: 'diagnostico',
    name: 'Diagnóstico / Raio-X',
    description: 'Específico para o Raio-X de Growth — hero + benefícios + FAQ + formulário de diagnóstico.',
    thumbnailUrl: null,
    category: 'Diagnóstico',
    sections: [
      { id: 'd1', type: 'hero', visible: true, props: { headline: 'Raio-X de Growth: Descubra o que trava seu crescimento', subheadline: 'Diagnóstico gratuito com IA. Receba um relatório completo em minutos.', ctaText: 'Fazer meu diagnóstico', ctaLink: '#form', badge: '100% Gratuito', alignment: 'center' } },
      { id: 'd2', type: 'features', visible: true, props: { heading: 'O que você vai descobrir', subheading: 'Análise completa em 5 pilares estratégicos', items: [
      ...
      { id: 'd3', type: 'faq', visible: true, props: { heading: 'Dúvidas frequentes', items: [
      ...
      { id: 'd4', type: 'cta', visible: true, props: { heading: 'Pronto para crescer?', subheading: 'Faça seu diagnóstico agora e descubra oportunidades escondidas.', ctaText: 'Começar diagnóstico', ctaLink: '#form' } },
      { id: 'd5', type: 'form', visible: true, props: { heading: 'Preencha para receber seu Raio-X', subheading: 'Dados seguros. Resultado imediato.', formId: null } },
      { id: 'd6', type: 'footer', visible: true, props: { text: '' } },
    ],
    globalStyles: { primaryColor: '#d1ae60', secondaryColor: '#1a1a2e' },
  },
  {
    id: 'saas_modern',
    name: 'SaaS Moderno',
