  ...
  return (
    ...
    >
      ...
      <div class="flex items-center gap-2 mb-1">
        ...
        <span class="text-3xs text-fg-muted">#{order + 1} · {offsetLabel}</span>
        {isBreakUp && (
          <span class="text-3xs px-1 py-0.5 rounded bg-danger/15 text-danger">break-up</span>
        )}
        {isManual && (
          <span class="text-3xs px-1 py-0.5 rounded bg-fg-muted/15 text-fg-muted">manual</span>
        )}
        {issueColor && (
          <span
      ...
      <div class="flex-1 flex flex-col">
        ...
        {showLegend && (
          <div class="px-3 py-2 border-t border-border text-2xs text-fg-muted flex items-center gap-3 flex-wrap">
            <span><span class="inline-block w-3 h-0.5 bg-fg-muted align-middle mr-1" /> próximo (explícito)</span>
            ...
            {editable && <span class="text-fg-muted">· paleta cria · clique edita · Del remove · Ctrl+Z desfaz · Ctrl+F busca · Execução mostra leads em tempo real</span>}
