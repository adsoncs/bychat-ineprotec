...
export const WIDGET_CATALOG: WidgetMetaWithCategory[] = [
  ...
  { category: 'negociacoes', metric: 'negotiations_onetime_open', title: 'Pagamento Único em Negociação', description: 'Valores cobrados uma vez só, em aberto agora — sem misturar com recorrência', icon: '🧾', defaultSize: 'sm', defaultType: 'kpi', availableTypes: ['kpi'] },
  ...
  { category: 'negociacoes', metric: 'negotiations_won_count', title: 'Matrículas Fechadas (por proposta)', description: 'Quantas propostas foram ganhas no período. Conta o ALUNO, não o responsável: um pai com dois filhos matriculados conta 2, enquanto "Negócios ganhos" conta 1', icon: '🎓', defaultSize: 'sm', defaultType: 'kpi', availableTypes: ['kpi'] },
  { category: 'negociacoes', metric: 'negotiations_conversion_rate', title: 'Conversão por Proposta', description: 'Das propostas abertas no período, quantas viraram venda. A versão por lead conta famílias; esta conta matrículas', icon: '🎯', defaultSize: 'sm', defaultType: 'kpi', availableTypes: ['kpi', 'gauge'] },
