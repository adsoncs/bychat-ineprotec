    ...
    <div class="flex items-center gap-3">
      <div class="relative flex-1">
        ...
        <input
          ...
          class="w-full h-9 pl-9 pr-3 rounded-md bg-surface border border-border text-sm text-fg placeholder:text-fg-subtle focus:outline-none focus:border-accent"
          autoComplete="off"
        />
      </div>
      <span class="text-xs text-fg-subtle whitespace-nowrap tabular-nums">
